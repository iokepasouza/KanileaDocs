...
First, download or clone the theme from the [Github repo](https://github.com/iokepasouza/KanileaDocs). Most likely you won't be pulling in updates once you start customizing the theme, so downloading the theme (instead of cloning it) probably makes the most sense. In Github, click the **Clone or download** button, and then click **Download ZIP**.
